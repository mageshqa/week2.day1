...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		importantNote.sendKeys("Important Note is very important");
		System.out.println("Important Note entered");

		// click update
		WebElement clickUpdate = driver.findElement(By.xpath("//*[@value=\"Update\"]"));
		clickUpdate.click();
